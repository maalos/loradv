...
struct OFDM {
  ...
  float _Complex *pilot_samples;
  float _Complex *rxbuf;
  float _Complex *pilots;
  float _Complex **rx_sym;
  float _Complex *rx_np;
  float _Complex *tx_uw_syms;
  COMP *tx_preamble;
  COMP *tx_postamble;
...
float _Complex qpsk_mod(int *);
float _Complex qam16_mod(int *);
void qpsk_demod(float _Complex, int *);
void qam16_demod(float _Complex, int *);
void ofdm_txframe(struct OFDM *, float _Complex *, float _Complex[]);
void ofdm_assemble_qpsk_modem_packet(struct OFDM *, uint8_t[], uint8_t[],
                                     uint8_t[]);
void ofdm_assemble_qpsk_modem_packet_symbols(struct OFDM *, float _Complex[],
                                             COMP[], uint8_t[]);
void ofdm_disassemble_qpsk_modem_packet(struct OFDM *, float _Complex rx_syms[],
